...
RUN mkdir -p /srv/.config/gcloud && chown -R nobody:nogroup /srv/.config && mkdir -p /srv/.kube && chown -R nobody:nogroup /srv/.kube && mkdir /srv/data && mkdir /srv/.skaffold && chown -R nobody:nogroup /srv/.skaffold
