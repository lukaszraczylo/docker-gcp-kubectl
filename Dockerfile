...
RUN if [ "${TARGETPLATFORM/linux\//}" = "arm64" ]; then \
    curl -LO https://github.com/inlets/inlets-pro/releases/download/0.8.3/inlets-pro-arm64; \
    mv inlets-pro-arm64 inlets-pro ; \
  else \
    curl -LO https://github.com/inlets/inlets-pro/releases/download/0.8.3/inlets-pro; \
  fi
